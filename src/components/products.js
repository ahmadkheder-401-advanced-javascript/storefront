                                ...
                                <Grid className={classes.jss7} container spacing={0} direction="row" justify="center" alignItems="center">
                                    ...
                                    <Grid key={idx} className={classes.jss8} container item xs={12} sm={6} lg={4} >
                                        ...
                                        <Card key={idx} className={classes.card}>
                                            ...
                                            <CardActions>
                                                <Button key={idx} style={{ fontSize: '0.8125rem' }} color="primary" onClick={() => updateFunctions(item)} >
                                                    ADD TO CART</Button>

                                                <Link href="/product">
                                                    <Button key={idx} style={{ fontSize: '0.8125rem' }} color="primary" onClick={() => props.get(item)} >
                                                        VIEW DETAILS</Button>
                                                </Link>
